...
* 
* The author provides no guarantees, warranties, or promises, implied or
*	otherwise.  By using this software you agree to indemnity the author
...
//   SPI include file is.
//////////////////////////////////////////////////////////////////////////////////
#define spi_send_read_byte(byte)	SSI_COM(byte)
...
#define nrf24l01_CE_IOREGISTER      GPIO_PORTA_DATA_Reg
...
// on the nrf24l01.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_CSN_IOREGISTER		GPIO_PORTA_DATA_Reg
...
//Change these definitions (and then recompile) to suit your particular application.
#define nrf24l01_IRQ_IOREGISTER		GPIO_PORTA_DATA_Reg
...
#define nrf24l01_SETUP_RETR_DEFAULT_VAL		0x0F
